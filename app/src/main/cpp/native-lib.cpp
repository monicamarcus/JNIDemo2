...
Java_com_example_monicamarcus_jnidemo2_MainActivity_stringFromJNI(
        JNIEnv *env,
        jobject instance) {
    std::string hello = "Hello from C++ and Monica Marcus";
...
JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM* vm, void* reserved) {
    ...
    jclass  clz = (env)->FindClass("com/example/jnidemo2/JniHandler");
...
Java_com_example_monicamarcus_jnidemo2_MainActivity_startTicks(JNIEnv *env, jobject instance) {
 ...
 */
JNIEXPORT void JNICALL
Java_com_example_monicamarcus_jnidemo2_MainActivity_stopTicks(JNIEnv *env, jobject instance) {
